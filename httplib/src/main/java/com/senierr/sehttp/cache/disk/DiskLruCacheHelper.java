package com.senierr.sehttp.cache.disk;
...
public class DiskLruCacheHelper {
    ...
    public DiskLruCacheHelper(Context context, String dirName, long maxSize) throws IOException {
    ...
    public DiskLruCacheHelper(Context context, File dir, long maxSize) throws IOException {
        mDiskLruCache = generateCache(context, dir, maxSize);
    }

    private DiskLruCache generateCache(Context context, File dir, long maxSize) throws IOException {
    ...
    private DiskLruCache generateCache(Context context, String dirName, long maxSize) throws IOException {
        return DiskLruCache.open(
